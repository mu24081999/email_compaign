        ...
        <div className="">
          <main class="flex w-full h-full shadow-lg rounded-3xl">
            <section class="flex flex-col w-2/12 bg-white rounded-l-3xl">
              <div class="w-16 mx-auto mt-12 mb-5 p-4 bg-gray-900 rounded-2xl text-white">
                <svg
              ...
              <nav class="relative flex gap-2 flex-col py-4 items-center">
                <div className="w-52 border py-5 bg-indigo-100 cursor-pointer px-2 rounded-lg">
                  mu24081999@gmail.com
                </div>
                <div className="w-52 overflow-hidden border py-5 bg-black text-white cursor-pointer px-2 rounded-lg">
                  umarliaqat@gmail.com
                </div>
                {/* <a
                  href="#"
                ...
                >
                  ...
                  <span class="absolute -top-2 -right-2 bg-red-600 h-6 w-6 p-2 flex justify-center items-center text-white rounded-full">
                    3
                  </span>
                </a>
                <a
              ...
              <ul class="mt-6">
                <li class="py-5 border-b px-3 transition hover:bg-indigo-100">
                  <a href="#" class="flex justify-between items-center">
                    <h3 class="text-lg font-semibold">Umar Liaqat</h3>
                ...
                <li class="py-5 border-b px-3 bg-gray-900 text-white">
                  <a href="#" class="flex justify-between items-center">
                    <h3 class="text-lg font-semibold">Umar Liaqat</h3>
            ...
            <section class="w-6/12 px-4 flex flex-col bg-white rounded-r-3xl">
              <div class="flex justify-between items-center h-48 border-b-2 mb-8">
                <div class="flex space-x-4 items-center">
                  ...
                  <div class="flex flex-col">
                    <h3 class="font-semibold text-lg">Umar Liaqat</h3>
                    <p class="text-light text-gray-400">
                      umar.liaqat@gmail.com
                    </p>
                  </div>
                </div>
                <div>
              ...
              <section>
                ...
                <article class="mt-8 text-gray-500 leading-7 tracking-wider">
                  <p>Hi Umar,</p>
                  <p>
                    Design and develop enterprise-facing UI and consumer-facing
                    UI as well as REST API backends.Work with Product Managers
                    and User Experience designers to create an appealing user
              ...
              <section class="mt-6 border rounded-xl bg-gray-50 mb-3">
                ...
                <div class="flex items-center justify-between p-2">
                  ...
                  <button class="bg-gray-900 text-white px-6 py-2 rounded-xl">
                    Reply
                  </button>
                </div>
              </section>
