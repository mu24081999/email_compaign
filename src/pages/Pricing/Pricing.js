    ...
    <div>
      ...
      <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className=" mx-auto mt-5 grid w-full grid-cols-1 items-center gap-y-6 sm:gap-y-0 px-5 lg:grid-cols-4 gap-5">
          ...
          <div className="rounded-3xl border-2 bg-white sm:mx-8 sm:p-10 lg:mx-0">
            <h3
              id="tier-hobby"
              className="text-base font-semibold leading-7 text-indigo-600"
            >
          ...
          <div className="relative rounded-3xl border-2 p-8 shadow-2xl ring-1 bg-white ring-gray-900 sm:p-10">
            <h3
              id="tier-enterprise"
              className="text-base font-semibold leading-7 text-indigo-600"
            >
          ...
          <div className="rounded-3xl p-8  bg-opacity-5 sm:mx-8 sm:p-10 lg:mx-0 border-2 bg-white">
            <h3
              id="tier-hobby"
