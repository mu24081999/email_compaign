        ...
        render={({ field }) => (
          <div>
            ...
            <textarea
              ...
              className={`p-5 block w-full bg-white rounded-xl border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-200 sm:text-sm sm:leading-6 ${
