...
import DropzoneIcon from "../../../../assets/image/dropzoneIcon.png";
              ...
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                  <span className="font-semibold">
                    <p className=" w-fit  p-2 text-white bg-[#006aff] to-white-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-bold rounded-lg text-sm px-5 text-center me-2 mb-2">
                      Upload Photos
                    </p>
                  </span>{" "}
                </p>
